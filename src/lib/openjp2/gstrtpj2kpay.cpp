 ...
 * units" and constructs the RTP packet header followed by actual JPEG 2000
...
static GstRtpJ2KMarker gst_rtp_j2k_pay_scan_marker (const guint8 * data, guint size, guint * offset)
{
